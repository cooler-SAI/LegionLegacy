...
class go_end_time_teleport : public GameObjectScript
{
    public:
        ...
        bool OnGossipHello(Player* pPlayer, GameObject* pGo)
        {
            ...
            {
                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, ru ? "Перенестись ко входу.":"Entryway of Time.", GOSSIP_SENDER_MAIN, START_TELEPORT);

                if (pPlayer->isGameMaster())
                {
                    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, ru ? "Изумрудное святилище драконов.":"Emerald Dragonshrine.", GOSSIP_SENDER_MAIN, TYRANDE_TELEPORT);
                    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, ru ? "Лазуритовое святилище драконов.":"Azure Dragonshrine.", GOSSIP_SENDER_MAIN, JAINA_TELEPORT);
                    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, ru ? "Обсидиановое святилище драконов.":"Obsidian Dragonshrine.", GOSSIP_SENDER_MAIN, BAINE_TELEPORT);
                    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, ru ? "Рубиновое святилище драконов.":"Ruby Dragonshrine.", GOSSIP_SENDER_MAIN, SYLVANAS_TELEPORT);
                    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, ru ? "Бронзовое святилище драконов.":"Bronze Dragonshrine.", GOSSIP_SENDER_MAIN, MUROZOND_TELEPORT);
                }
                else
                {
